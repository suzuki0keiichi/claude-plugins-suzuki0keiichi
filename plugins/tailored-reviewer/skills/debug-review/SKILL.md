...
description: >
  ...
  "生成スキルを検証", or automatically after generate-review completes.
...
**Prerequisites:** Generated skills exist in .claude/skills/ (from generate-review).
...
If issues found: return to generate-review with specific fix requests.
