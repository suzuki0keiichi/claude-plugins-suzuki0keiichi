...
7. code-health (cognitive load + debt trajectory + design integrity + observability)
8. strategic-alignment (problem diagnosis + roadmap consistency)
...
- **Selective knowledge-base injection**: only include knowledge-base entries relevant to this specific concern (NOT the full knowledge-base)
  ...
  - For code-health: design-principles.md (architectural patterns, module boundaries), bug-patterns.md (areas with high churn indicating debt), implementation-principles.md (coding conventions)
  - For strategic-alignment: roadmap.md (planned features, migration plans), design-principles.md (architectural direction), project-context.md (project goals)
  - etc.

**Verification**: After generating, confirm you have exactly 8 files:
...
- `.claude/skills/strategic-alignment/SKILL.md`
...
- [ ] strategic-alignment/SKILL.md exists
